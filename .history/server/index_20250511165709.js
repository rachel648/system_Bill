...
const stripe = require('stripe')(process.env.STRIPE_SECRET_KEY);  // Make sure to add your Stripe secret key in .env
...
app.post('/api/payment', async (req, res) => {
  ...
  try {
    ...
    const paymentIntent = await stripe.paymentIntents.create({
      amount: parseFloat(amount) * 100,  // Amount is in smallest unit (cents)
      currency: 'usd',
