...
const MPESA_CONSUMER_KEY = 'YourSandboxConsumerKeyHere'; // Replace this
const MPESA_CONSUMER_SECRET = 'YourSandboxConsumerSecretHere'; // Replace this
const CALLBACK_URL = 'https://your-ngrok-url.com/callback'; // Replace with a live/public URL
