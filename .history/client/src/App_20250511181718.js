...
import Receipts from './Receipts'; // Assuming you have a Receipts component

const App = () => {
  return (
    <Router>
      <div>
        {/* WiFi Packages, Hotspot, and Receipts Routes with Sidebar Navigation */}
        <Routes>
          ...
          <Route 
            ...
            element={
              <div style={{ display: 'flex' }}>
                {/* Navigation Sidebar for WiFi Packages, Hotspot, and Receipts */}
                <div style={{ width: '200px', backgroundColor: '#f4f4f4', padding: '20px' }}>
                  ...
                  <ul style={{ listStyleType: 'none', padding: 0 }}>
                    ...
                    <li>
                      <Link to="/receipts" style={linkStyle}>Receipts</Link>
                    </li>
                  </ul>
                </div>
